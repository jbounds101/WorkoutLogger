...
const username = encodeURIComponent(process.env.SERVER_USERNAME);
const password = encodeURIComponent(process.env.SERVER_PASSWORD);
const cluster = process.env.SERVER_CLUSTER;
